...
def create_app():
    ...
    face_recognition = FaceRecognitionSystem(
        model_path=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data/face_encodings.pkl'),
        enrollment_dir=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data/enrollments/'),
    ...
    attendance_processor = AttendanceProcessor(
        ...
        unknown_faces_dir=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data/unknown_faces/')
    )
    ...
    def teardown_app(exception=None):
        face_recognition.save_encodings(
            os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data/face_encodings.pkl')
        )
